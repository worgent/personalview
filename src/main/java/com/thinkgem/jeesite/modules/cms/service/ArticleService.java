...
//		dao.updateDelFlag(id, isRe!=null&&isRe?Article.DEL_FLAG_NORMAL:Article.DEL_FLAG_DELETE);
	...
	public Article findPrevArticleByWeight(Article article){
		return dao.findPrevArticleByWeight(article);
	}
	public Article findNextArticleByWeight(Article article){
		return dao.findNextArticleByWeight(article);
	}
	/**
	 * 点击数加一
	 */
	...
	@Transactional(readOnly = false)
	public void updateCommentsAddOne(String id) {
		dao.updateCommentsAddOne(id);
	}
	@Transactional(readOnly = false)
	public void updateCommentsSubOne(String id) {
		dao.updateCommentsSubOne(id);
	}
	@Transactional(readOnly = false)
	public void updateSuppotsAddOne(String id) {
		dao.updateSuppotsAddOne(id);
	}
	@Transactional(readOnly = false)
	public void updateSuppotsSubOne(String id) {
		dao.updateSuppotsSubOne(id);
	}
...
//
//	//按权重获得推荐文章
//	public List<Article> getArticleByWeight(int limit){
