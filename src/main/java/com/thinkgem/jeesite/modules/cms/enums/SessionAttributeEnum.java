package com.thinkgem.jeesite.modules.cms.enums;
...
public enum SessionAttributeEnum {
    ...
    //页面来的验证码来源
    REGIST_USER_CODE("registUserCode", "用户注册验证码"),
    REGIST_USER_PHONE("registUserPhone", "用户注册手机号"),
    REGIST_USER_CODE_TIME("registUserCodeTime", "用户注册验证码申请时间"),
