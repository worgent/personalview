...
public class CategoryService extends TreeService<CategoryDao, Category> {
	...
	public static final String COMMON_CACHE_CATEGORY_LIST = "commonCategoryList";
...
//				list.addAll(0, dao.find(dc));
	...
	public List<Category> findByParentDelegate(String parentId, String siteId){

//		List<Category> list = (List<Category>)UserUtils.getCache(COMMON_CACHE_CATEGORY_LIST);
//		if (list == null){
