...
<script type="text/javascript">
	...
	function comment(id){
		if ($("#commentForm"+id).html()==""){
			...
			$("#commentForm"+id+" button").click(function(){
...
<div id="commentForm0"></div>
	<script>
		function saveComment(commentID){
			alert("saveComment,"+commentID);
			var ob = $("#commentForm"+commentID);
			//检查
			if( $("#commentForm"+commentID+" textarea").val() == "")
			{
				alert("评论内容不能为空");
				return false;
			}
//			alert($("#commentForm0").serialize());
//			alert($("#commentForm"+commentID).serialize());
			$.ajax({
				url:"/f/commentSave.do",
				type:"POST",
				data: $("#commentForm"+commentID+" form").serialize(),
	...
	<div class="control-group">
	<div class="controls">
	<button class="btn btn-default" type="button" value="提 交"/>&nbsp;
	</div>
	</div>
